 ...
 * generated in the at.fhooe.mc.jaxws.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _SaySomethingResponse_QNAME = new QName("http://service.jaxws.mc.fhooe.at/", "saySomethingResponse");
    private final static QName _GetDataResponse_QNAME = new QName("http://service.jaxws.mc.fhooe.at/", "getDataResponse");
    private final static QName _DummyData_QNAME = new QName("http://service.jaxws.mc.fhooe.at/", "dummyData");
    private final static QName _SaySomething_QNAME = new QName("http://service.jaxws.mc.fhooe.at/", "saySomething");
    private final static QName _GetData_QNAME = new QName("http://service.jaxws.mc.fhooe.at/", "getData");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: at.fhooe.mc.jaxws.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jaxws.mc.fhooe.at/", name = "saySomethingResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jaxws.mc.fhooe.at/", name = "getDataResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jaxws.mc.fhooe.at/", name = "dummyData")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jaxws.mc.fhooe.at/", name = "saySomething")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.jaxws.mc.fhooe.at/", name = "getData")
