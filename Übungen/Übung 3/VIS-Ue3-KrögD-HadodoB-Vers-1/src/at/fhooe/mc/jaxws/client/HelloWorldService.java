 ...
 * 
 */
@WebServiceClient(name = "HelloWorldService", targetNamespace = "http://server.jaxb.mc.fhooe.at/", wsdlLocation = "file:/Users/David/HelloWorld.wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDSERVICE_QNAME = new QName("http://server.jaxb.mc.fhooe.at/", "HelloWorldService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("file:/Users/David/HelloWorld.wsdl");
    ...
    public ISimpleInterface getHelloWorldPort() {
        return super.getPort(new QName("http://server.jaxb.mc.fhooe.at/", "HelloWorldPort"), ISimpleInterface.class);
    }
    ...
    public ISimpleInterface getHelloWorldPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.jaxb.mc.fhooe.at/", "HelloWorldPort"), ISimpleInterface.class, features);
    }
